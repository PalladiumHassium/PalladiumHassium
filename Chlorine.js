...
function openPopupWindow17() {
  ...
  var popupContent17 = "<div style='display: flex; flex-direction: column; align-items: center; justify-content: flex-start; height: 100%; text-align: center;'>"
                   ...
                   + "<p>" + text + "</p>"
                   + "<p>A chlorine atom has seven <b>valence electrons</b> (valence means the <b>the outermost</b>) at its valence shell, making the element extremely unstable! The reason is because that for most elements, <b>it needs <u>8</u> valence electrons to make it stable, also known as the “stable octet.”</b> That is also why all the halogens are unstable, while the noble gases – helium, neon, argon, krypton, and radon (with an exception to xenon, Xe, which does react under some circumstances) – are generally stable.</p>"
                   + "<p>Interestingly – when sodium, which reacts vigorously to the water, and chlorine, which killed numerous people during the First World War, react, they turn out to <b>form something we need in our day-to-day life, table salt (NaCl)!</b> As mentioned before, chlorine is one of the halogen family, which can neutralize the charges for the metals (sodium in this case) <b>because it is “receiving” an electron from the metal and the metal is giving the nonmetal (Cl) its extra electrons to make them both stable.</b></p>"
                   + "<p></p>"
                   + "<h2><u>Discovery</u></h2>"
                   + "<p>At the earliest, the rock salt – which is just NaCl – was known for several millenia back, and it was also known as the main material of the salts dissovled in the seawater. It then, interestingly, partially became the currency of the soldiers in Roman times!</p>"
                   + "<p>It wasn't until 1648 when the German chemist Johann Rudolf, who had obtained a powerful acid through burning the moist salt into a charcoal furnace and then condensing the fumes in a receiver – of which he named it <b>“spirit of salt.”</b> He later on then got the same product through heating the salt with the sulfuric acid, which yielded to what is now known as the <b>hydrochloric acid.</b></p>"
                   ...
                   + "<p>As mentioned before... Chlorine was used as a gas weapon during the First World War. <b>It was used by both sides, the Triple Entente and the Triple Alliance!</b> The initial attack of such gas at a significant level happened in April 1915, in Ypres, Belgium. It was released by Germany on the Triple Alliance side. The attack, consequently, <b>resulted into a greate number of casualties among the British and Canadian forces!</b></p>"
                   + "<p>However, since the gas was making numerous people suffering on the side of Triple Entente, they quickly developed some types of protection to prevent from getting killed due to such highly dangerous gas. The thiosulfate-laced cotton pad had efficiently neutralized the gas once chlorine was known to be the chemical agent used. <b>And so, by July of 1915, a “hypo helmet” was invented</b> – it was made up of the <b>wool hood soaked in thiosulfate (Na<sub>2</sub>S<sub>2</sub>O<sub>3</sub>), sodium bicarbonate (Na<sub>2</sub>CO<sub>3</sub>) and glycerin (C<sub>3</sub>H<sub>8</sub>O<sub>3</sub>)</b>.</p>"
                   + "<p>Despite the invention which effectively protected the soldiers, such dangerous gas still created a catastrophic holocaust. In response to such high number of casualties caused, the Entente – France and Britain (now known as the United Kingdom, UK) – speedily improved their weapon uses in terms of chemical ammunitions. As the result, <b>by mid-1916, both sides mixed chlorine and phosgene into their firearms, attempting to make the casualties to an even larger scale</b>.</p>"
                   + "<p></p>"
                   ...
                   + "<p>If we breathe in a small qunatity of Cl gas for a short period of time, it would affect our respiratory system – which can <b>vary from coughing and chest pain to the retention of the water in the lungs</b>. Furthermore, the gas would <b>irritate our eyes, skins and again, our respiratory system.</b></p>"
                   + "<p>Although the effects of breathing in small amount of Cl gas for an extented period of time are not known, <b>some studies had shown that the worders associating with repeat inhalation of such gas would develop adverse effects.</b></p>"
                   + "<p></p>"
