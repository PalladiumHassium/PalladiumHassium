...
function openPopupWindow9() {
  ...
  var popupContent9 = "<div style='display: flex; flex-direction: column; align-items: center; justify-content: flex-start; height: 100%; text-align: center;'>"
                   ...
                   + "<p>Three types of chemical compounds – NaF, SnF<sub>2</sub> and Na<sub>2</sub>PO<sub>3</sub>F – are the fluorine-containing compounds being added to toothpaste to prevent our teeth from tooth decay.</p>"
