...
function openPopupWindow10() {
  ...
  var popupContent10 = "<div style='display: flex; flex-direction: column; align-items: center; justify-content: flex-start; height: 100%; text-align: center;'>"
                   ...
                   + "<p></p>"
                   + "<h2><u>Discovery</u></h2>"
                   + "<p>In 1898, Sir William Ramsay and Morris W. Travers – who are both British chemists – discovered neon as a component of fractions of liquified crude (simpeler version of) argon which is the easiest to evaporate. They immediately identified it as a new element as it emits a unique glow when simulated electrically.</p>"
                   ...
                   + "<p>The characteristic of reddish-orange colored of this element are commonly used as the signs for advertisement – which became popularized during the 1920s – in some high-voltage testers, as well as gaseous and fluorscent conduction lamps. Other applications of this element include lightning arrestors, television tubes, meters tubes and gas lasers.</p>"
                   + "<p>It is also used with a combination of different gases or singly in the electronic industry for gas-filled electron tubes. Additionally, helium-neon mixtures are used for marine divers to breathe in the sea because nitrogen at high pressure is more soluble than helium in blood.</p>"
                   + "<p>.</p>"
                   + "</div>";
