...
var dataAttributes13 = {
    ...
    text: "Aluminum (<b>symbol: Al</b>) is a solid, non-magnetic, non-lustrous, and silvery white metal with some bluish tint. Its pure form is a soft metal, but it becomes hardened when it is being tempered and alloyed. Aluminum has a high <b>malleability</b> (meanning that it <b>has an excellent ability to be bent and shaped in various forms</b>) and a high ductility (can be <b>stretched, pulled, or beaten to a very thin form</b>). It is a good conductor of electricity and heat, a highly reflective surface, and a corrosive-resistant material. For pure aluminum, it has a melting point of 660 degrees Celsius and a boiling point of 2470 degrees Celsius; however, they change when aluminum is alloyed with other materials."
};
...
function openPopupWindow13() {
  ...
  var popupContent13 = "<div style='display: flex; flex-direction: column; align-items: center; justify-content: flex-start; height: 100%; text-align: center;'>"
                   ...
                   + "<p>Aluminum and iron (III) oxide (Fe<sub>2</sub>O<sub>3</sub>) can burn things down with a temperature of <b><u>3000 degrees Celsius</u></b> when the react <b>because it releases an enormously strong energy – because this reaction forms a relatively stable compound: aluminum oxide.</b> Below here is how it reacts: (Note that, the object that appears to be a long silvery metal is the magnesium strip, and the red powder is the mixture of aluminum and iron (III) oxide)</p>"
                   ...
                   + "<p>Up until 1854, aluminum was still an expensive metal – until Henri Saint-Claire Deville in Paris, France found an alternative way to isolate aluminum by replacing potassium with sodium (which was much more cheaper) in the reaction. Aluminum was still quite expensive after that, but it became popularized – it was used in ornaments, but still had no practical uses yet.</p>"
                   + "<p>Two years later in 1856, it was stated by Berzelius that Wöhler was the one who succeeded back in 1827 for with respect to the alternative way of isolating aluminum that he found – hence he was usually the one who receives the credit for this discovery. 30 years after that, Hall-Héroult process was invented by both American chemist Charles Martin Hall and French chemist Paul Héroult independently – in which aluminum metal was isolated from oxide electrolytically, and was done inexpensively!</p>"
                   ...
                   + "<p><b><i><u>High aluminum concentration also affect birds and other animals in these ways:</u></i></b> <br> <b>Consuming contaminated prays</b> – which can lead to thinning eggshell and low birthweights. <br> <b>Breathing aluminum through air</b> – which which may cause lung problems, weight loss and decline in activity.</p>"
                   ...
                   + "<p><b><i><u>In summary, although aluminum can ben a useful and a desirable material, it is like beryllium – an eco-unfriendly material!</u></i></b></p>"
                   + "<p>.</p>"
                   + "</div>";
