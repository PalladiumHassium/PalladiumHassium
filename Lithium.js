...
function openPopupWindow3() {
  ...
  var popupContent3 = "<div style='display: flex; flex-direction: column; align-items: center; justify-content: flex-start; height: 100%; text-align: center;'>"
                   ...
                   + "<p>“Lithium Isotope.” <i>Lithium Isotope - an Overview | ScienceDirect Topics</i>, <a href = www.sciencedirect.com/topics/earth-and-planetary-sciences/lithium-isotope>www.sciencedirect.com/topics/earth-and-planetary-sciences/lithium-isotope.</a></p>" 
                   + "<p>“Lithium - Element Information, Properties and Uses: Periodic Table.” <i>Lithium - Element Information, Properties and Uses | Periodic Table</i>, <a href = www.rsc.org/periodic-table/element/3/lithium>www.rsc.org/periodic-table/element/3/lithium.</a></p>"
                   + "<p>“Lithium Isotope.” <i>Lithium Isotope - an Overview | ScienceDirect Topics</i>, <a href = www.sciencedirect.com/topics/earth-and-planetary-sciences/lithium-isotope>www.sciencedirect.com/topics/earth-and-planetary-sciences/lithium-isotope.</a></p>" 
                   + "<p>“Lithium.” <i>World Nuclear Association</i>, <a href = world-nuclear.org/information-library/current-and-future-generation/lithium.aspx>world-nuclear.org/information-library/current-and-future-generation/lithium.aspx.</a></p>"
                   + "<p>LLC, Bioenno Tech. “The Pros and Cons of Lithium Ion Batteries: A Deep Dive.” <i>Bioenno Power</i>, Bioenno Power, 12 Oct. 2023, <a href = www.bioennopower.com/blogs/news/the-pros-and-cons-of-lithium-ion-batteries-a-deep-dive>www.bioennopower.com/blogs/news/the-pros-and-cons-of-lithium-ion-batteries-a-deep-dive.</a></p>"
                   + "<p>.</p>"
                   + "</div>";
